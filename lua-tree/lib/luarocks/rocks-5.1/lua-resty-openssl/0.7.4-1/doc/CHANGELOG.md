...
## [0.7.4] - 2021-08-02
### bug fixes
- **extension:** fallback to ASN1_STRING_print in extension:text where X509V3_EXT_print is not available [6b562de](https://github.com/fffonion/lua-resty-acme/commit/6b562de940340822a810292f038794bef05b0753)
...
## [0.7.3] - 2021-06-29
### bug fixes
- **pkey:** only pass in passphrase/passphrase_cb to PEM_* functions [15e512c](https://github.com/fffonion/lua-resty-acme/commit/15e512c9f71ec34a6f842534b3419172beaf4303)
- **pkey:** avoid callbacks overflow when setting passphrase_cb [b178224](https://github.com/fffonion/lua-resty-acme/commit/b178224e57a1353ecf12c45a34987828502243d7)

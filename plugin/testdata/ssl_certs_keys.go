...
-----END CERTIFICATE-----`
  KeyClient = `-----BEGIN RSA PRIVATE KEY-----
...
a2EQ5BzyOzQ81H4=
-----END CERTIFICATE-----`
  KeyClient2 = `-----BEGIN RSA PRIVATE KEY-----
...
//       Not After : Sep  3 16:49:53 2294 GMT
	...
	CertAltEcdsa =  `-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`
	KeyAltEcdsa = `-----BEGIN EC PRIVATE KEY-----
...
//   Subject: C = US, ST = California, L = San Francisco, O = Kong, OU = Core, CN = ssl-alt-alt.com
	...
	CertAltAltEcdsa = `-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----`
	...
	KeyAltAltEcdsa = `-----BEGIN EC PRIVATE KEY-----
